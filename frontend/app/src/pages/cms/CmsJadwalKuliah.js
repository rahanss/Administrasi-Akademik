...
export default function CmsJadwalKuliah() {
  ...
  const [form, setForm] = useState({ mata_kuliah_id: '', dosen_id: '', hari: 'Senin', jam_mulai: '08:00', jam_selesai: '10:00', ruang: '', kampus: 'D', semester: '', tahun_akademik: '' });
  ...
  const openCreate = () => {
    setEditing(null);
    setForm({ mata_kuliah_id: '', dosen_id: '', hari: 'Senin', jam_mulai: '08:00', jam_selesai: '10:00', ruang: '', kampus: 'D', semester: '', tahun_akademik: '' });
    setModal(true);
    setErr('');
  };
  ...
  const openEdit = (r) => {
    setEditing(r);
    setForm({ mata_kuliah_id: r.mata_kuliah_id, dosen_id: r.dosen_id || '', hari: r.hari || 'Senin', jam_mulai: (r.jam_mulai || '').slice(0, 5), jam_selesai: (r.jam_selesai || '').slice(0, 5), ruang: r.ruang || '', kampus: r.kampus || 'D', semester: r.semester || '', tahun_akademik: r.tahun_akademik || '' });
    setModal(true);
    setErr('');
  };
  ...
  return (
    <>
      <div className="cms-page-header">
        <h1 className="cms-page-title">Jadwal Kuliah</h1>
      ...
      {modal && (
        <div className="cms-modal-overlay" onClick={closeModal}>
          <div className="cms-modal" onClick={e => e.stopPropagation()} style={{ maxWidth: 440 }}>
            <div className="cms-modal-header">{editing ? 'Edit Jadwal Kuliah' : 'Tambah Jadwal Kuliah'}</div>
