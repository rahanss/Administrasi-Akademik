        ...
        <div className="content-related-cards">
          ...
          >
            <span className="related-icon">
              <img src="/icons/PanduanAdministrasi.png" alt="Pendaftaran & Registrasi" className="related-icon-image" />
            </span>
          ...
          >
            <span className="related-icon">
              <img src="/icons/PanduanAdministrasi.png" alt="Akademik" className="related-icon-image" />
            </span>
          ...
          >
            <span className="related-icon">
              <img src="/icons/JadwalUjian.png" alt="Ujian & Penilaian" className="related-icon-image" />
            </span>
