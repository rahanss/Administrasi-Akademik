...
│
├── frontend-apps/        # Frontend User Applications (SPA untuk mahasiswa)
│   ├── src/
│   │   ├── components/
│   │   │   ├── Layout/
...
│   │   │   ├── Breadcrumb.css
│   │   │   ├── LoadingSpinner.js    # Komponen loading (HCI)
│   │   │   └── LoadingSpinner.css
│   │   └── pages/
...
│   └── (akan dibuat untuk Content Management System)
│
